...
class Flight(models.Model):
    ...
    date_time_origin = models.DateTimeField(db_column="origin date and time", null=True, blank=True)
    date_time_destination = models.DateTimeField(db_column="destination date and time", null=True, blank=True)
    total_seats_num = models.IntegerField(db_column="seats on flight", null=False, blank=False)
    available_seats = models.IntegerField(db_column="available seats on flight", null=False, blank=False)
    is_canceled = models.BooleanField(db_column="is canceled", null=False, blank=False)
    price = models.FloatField(db_column="ticket price", null=False, blank=False)
...
class Order(models.Model):
    ...
    seats_num = models.IntegerField(db_column="seats_num", null=False, blank=False)
